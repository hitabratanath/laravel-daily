<x-layout>
    <main class="container mx-auto p-4">
        ...
        <section class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <p class="mb-4">Our team is composed of experienced professionals who are passionate about what they do.
            </p>
        ...
        <section class="bg-white shadow-md rounded-lg p-6">
            ...
            <p class="mb-4">We strive to innovate and continuously improve our services to meet the needs of our
                clients.</p>
        </section>
    </main>
</x-layout>
